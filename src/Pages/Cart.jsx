...
function Cartheader() {
  return (
    <>
      <Container fluid style={{ height: "78px" }} className="border-bottom">
        <div className="p-3" style={{ width: "1397px" }}>
          <Row className="align-items-center">
            ...
            <Col lg={4}>
              <div className=" d-flex justify-content-end align-items-center">
                ...
                <div>
                <p className="ms-1 " style={{letterSpacing :"3px" ,fontSize :"12px"}}>100 % SECURE</p>
                </div>
              </div>
            </Col>
          </Row>
...
function Cartbody() {
  return (
    <>
      <Container fluid>
        <Container className="m-auto" style={{ width: "980px" }}>
          <Row>
            <Col lg={7}>
              <div className="pt-4 ">
                <div
            ...
            <Col lg={5}>
              <div className="pt-4 py-1 px-2  ps-4  py-1 px-2  border-start">
                ...
                <div>
                  ...
                  <div className="d-flex px-3 rounded" style={{ background: "#fff1ec" }}>
                    <div className="px-1" style={{ height: "99px" }}>
                      <img src={gift} height={100} />
                    </div>
                    <div>
                     <div className="pt-2" style={{ fontSize: "14px",fontWeight:"700" }}>Buying for loved one ?</div>
                      <p className="m-0 p-0" style={{ fontSize: "12px" }}>
                        Gift wrap and personalised message on card,
                        <br /> Only for 25
                      </p>
                      <span style={{ fontSize: "12px",fontWeight:"700",color:"red" }}>ADD GIFT WRAP</span>
                    </div>
                  </div>
                  <div>
...
function Cartfoot() {
  return (
    <>
      <Container fluid>
        <Container
          className=" my-5 m-auto pt-2"
          style={{ width: "980px", background: "#fff5f7" }}
        >
