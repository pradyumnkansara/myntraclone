                ...
                <Container>
                    <Row className='justify-content-center pt-5'>
                        <Col lg={4} xs={12} className='bg-white'>
                            <div className='p-3'>
                                <h4 className='fw-bold pt-5' style={{ color: '#424553' }}>Register your account</h4>
                                <form action="">
                                    <input type="text" placeholder='Name' className='w-100 my-3 p-2 border username-box' />
                                    <input type="email" placeholder='Email ' className='w-100 my-3 p-2 border username-box' />
                                    <input type="text" placeholder="Password" className='w-100 my-3 p-2 border' />
                                    <input type="text" placeholder="Phone number" className='w-100 my-3 p-2 border' />
